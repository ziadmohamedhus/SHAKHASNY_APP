      ...
      child:BlocConsumer<AppCubit,AppStates>(
        ...
        builder: (context,state)=> Scaffold(
          body:ConditionalBuilder(
            condition: AppCubit.get(context).new_appointments.isEmpty,
            ...
            builder: (context)=>ListView(
              children: [
                ...
                for(int i=0;i<AppCubit.get(context).new_appointments.length;i++)
                    Dismissible(
                      key: Key(AppCubit.get(context).new_appointments[i].time.toString()),
                      child: Padding(
                          ...
                          child: Padding(
                            ...
                            [
                              CircleAvatar(
                                ...
                                radius: 35.0,
                                child: Text('${AppCubit.get(context).new_appointments[i].time}',
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text('${AppCubit.get(context).new_appointments[i].patient!.firstName} ${AppCubit.get(context).new_appointments[i].patient!.lastName}',
                                      style: TextStyle(
                                        color: HexColor('32313a'),
                                        fontSize: 20.0,
                                        fontWeight: FontWeight.w600,),),
                                    Text('${AppCubit.get(context).new_appointments[i].date}',
                                      style: TextStyle(
