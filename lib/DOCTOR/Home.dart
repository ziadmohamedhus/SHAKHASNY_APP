                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    MaterialButton(
                                      onPressed: () {Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context)=> new_appointment()));},
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    MaterialButton(
                                      onPressed: () {Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context)=> done_appointment()));},
                                      color: HexColor('8a86e2'),
                                      child: Text(
                                        'Show!',
                                        style: TextStyle(
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Padding(
                                padding: const EdgeInsets.all(10.0),
                                child: Image.asset('asset/icon/archive.png',height: 140,),
                              ),
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    ...
                                    MaterialButton(
                                      onPressed: () {Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context)=> cancel_appointment()));},
                                      color: HexColor('ffe0f4'),
                                      child: Text(
                                        'Show!',
                                        style: TextStyle(
