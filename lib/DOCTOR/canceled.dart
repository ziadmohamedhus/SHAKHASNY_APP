                ...
                if (AppCubit.get(context).reject_appointments.length != 0) {
                  return ListView(
                    children: [
                      ...
                      for (int i = 0;
                          i < AppCubit.get(context).reject_appointments.length;
                          i++)
                        Dismissible(
                              ...
                              child: Padding(
                                ...
                                child: Row(children: [
                                  CircleAvatar(
                                    ...
                                    radius: 35.0,
                                    child: Text(
                                      '${AppCubit.get(context).reject_appointments[i].time}',
                                      style: TextStyle(
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          '${AppCubit.get(context).reject_appointments[i].patient!.firstName} ${AppCubit.get(context).reject_appointments[i].patient!.lastName}',
                                          style: TextStyle(
                                            color: HexColor('32313a'),
                                            fontSize: 20.0,
                                        ...
                                        Text(
                                          '${AppCubit.get(context).reject_appointments[i].date}',
                                          style: TextStyle(
