                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: ListView(
                            ...
                            children: [
                              InkWell(
                                onTap: (){Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context)=> Doctors_for_manager()));},
                                child: Container(
                              ...
                              InkWell(
                                onTap: (){
                                  Navigator.push(context, MaterialPageRoute(builder: (context)=>all_patient()));
                                },
                                child: Container(
                                  padding: EdgeInsets.all(5.0),
                                  decoration: BoxDecoration(
                              ...
                              InkWell(
                                onTap: (){Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context)=> Accounts()));},
                                child: Container(
                                  padding: EdgeInsets.all(5.0),
                                  decoration: BoxDecoration(
                                    color: HexColor('ffe0f4'),
