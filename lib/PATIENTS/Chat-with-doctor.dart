...
class Chat_with_doctor extends StatelessWidget {
  Chat_with_doctor({required this.Doctor}) ;
            ...
            children: [
              Expanded(
                child: ListView(children: [
                  ...
                  build_doctor_Message('ok iok iok iok iok i'),
                  build_My_Message('i feel bad 🤒'),
                  build_My_Message('ok i'),
                  build_doctor_Message('ok '),
